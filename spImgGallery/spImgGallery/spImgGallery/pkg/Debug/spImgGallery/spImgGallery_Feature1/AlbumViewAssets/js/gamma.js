	...
	var $window = $( window ),
		...
		_createSingleView = function() {
			...
			if( !Gamma.singleview ) {
				...
				$( '<div class="gamma-single-view"><div class="gamma-options gamma-options-single"><div class="gamma-buttons"><button type="button" class="gamma-btn-close"></button></div></div></div>' )
